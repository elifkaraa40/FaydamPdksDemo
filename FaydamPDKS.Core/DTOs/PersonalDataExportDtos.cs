...
public sealed record PersonalDataProfileDto(Guid Id, string EmployeeNumber, string FullName, string Email, string? PhoneNumber, string? Workplace, string? Department, DateOnly? HireDate, DateOnly? BirthDate, bool IsActive, bool IsEmailNotificationEnabled, bool IsSmsNotificationEnabled);
