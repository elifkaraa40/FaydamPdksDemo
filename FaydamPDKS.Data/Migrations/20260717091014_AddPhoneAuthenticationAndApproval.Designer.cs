...
namespace FaydamPDKS.Data.Migrations
{
    ...
    [Migration("20260717091014_AddPhoneAuthenticationAndApproval")]
    partial class AddPhoneAuthenticationAndApproval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FaydamPDKS.Core.Models.AttendanceQrCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkplaceId", "ZoneId", "EventType", "IsActive");

                    b.ToTable("attendance_qr_codes");
                });
            ...
            modelBuilder.Entity("FaydamPDKS.Core.Models.PhoneVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FaydamPDKS.Core.Models.AttendanceQrCode", b =>
                {
                    ...
                    b.HasOne("FaydamPDKS.Core.Models.Zone", "Zone")
                        .WithMany()
